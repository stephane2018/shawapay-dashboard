...
export const generateBureauData = (): BureauExportData => {
  const bureauCode = "LP-BAM-001"
  const bureauName = "Bureau de Poste Abidjan Centre"
...
export const dummyBureauData = generateBureauData()
